        ...
        implements NavigationView.OnNavigationItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String interestName = interestList.get(4).getInterestName();
        double[] notificationTimes = interestList.get(4).getNotifTimes();

        int hour, minute, second;

        Log.d(interestName, "----------------------------------------------------------------");
        Log.d(interestName, "----------------------------------------------------------------");
        for(int j = 0; j < interestList.get(4).getNumNotifications(); j++){
        ...
        hour = (int) notificationTimes[6];
        minute = (int) (notificationTimes[6] * 60 % 60);
        second = (int) (notificationTimes[6] * 60 * 60 % 60);
        Log.d(interestName,String.valueOf(hour + ":" + minute + ":" + second));
        ...
        Log.d(interestName, "----------------------------------------------------------------");
        interestName = interestList.get(1).getInterestName();
        notificationTimes = interestList.get(1).getNotifTimes();

        for(int j = 0; j < interestList.get(1).getNumNotifications(); j++){
        ...
        hour = (int) notificationTimes[0];
        minute = (int) (notificationTimes[0] * 60 % 60);
        second = (int) (notificationTimes[0] * 60 * 60 % 60);
        Calendar calendar1 = Calendar.getInstance();

        calendar1.set(Calendar.HOUR_OF_DAY, hour);
        calendar1.set(Calendar.HOUR_OF_DAY, minute);
        calendar1.set(Calendar.HOUR_OF_DAY, second);
...
//////////////-----------------------------------------------------------------------------------------
        interestName = interestList.get(3).getInterestName();

        notificationTimes = interestList.get(3).getNotifTimes();
        ...
        Intent intent3 = new Intent(getApplicationContext(), Notification3.class);
