...
public class Notification_receiver9 extends BroadcastReceiver {

    public final String CHANNEL_ID = "Personal Notification";
    private final int NOTIFICATION_ID = 109;
    ...
    public void onReceive(Context context, Intent intent) {
       ...
       // }
        ...
        PendingIntent pendingIntent9 = PendingIntent.getActivity(context, 109, repeating_intent, PendingIntent.FLAG_UPDATE_CURRENT);

        // Interest 9

        NotificationCompat.Builder builder9 = new NotificationCompat.Builder(context, CHANNEL_ID)
                .setContentIntent(pendingIntent9)
                //.setSmallIcon(android.R.drawable.arrow_up_float)setSmallIcon(icon);
                .setSmallIcon(R.mipmap.ic_launcher)
                .setContentTitle(name[8])
        ...
        if (name[8] != "")
            notificationManager.notify((109), builder9.build());
