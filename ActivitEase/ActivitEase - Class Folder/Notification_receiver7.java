...
public class Notification_receiver7 extends BroadcastReceiver {

    public final String CHANNEL_ID = "Personal Notification";
    private final int NOTIFICATION_ID = 107;
    ...
    public void onReceive(Context context, Intent intent) {
       ...
       // }
        ...
        PendingIntent pendingIntent7 = PendingIntent.getActivity(context, 107, repeating_intent, PendingIntent.FLAG_UPDATE_CURRENT);

        // Interest 7

        NotificationCompat.Builder builder7 = new NotificationCompat.Builder(context, CHANNEL_ID)
                .setContentIntent(pendingIntent7)
                //.setSmallIcon(android.R.drawable.arrow_up_float)setSmallIcon(icon);
                .setSmallIcon(R.mipmap.ic_launcher)
                .setContentTitle(name[6])
        ...
        if (name[6] != "")
            notificationManager.notify((107), builder7.build());
