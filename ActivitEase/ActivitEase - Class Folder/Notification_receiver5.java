...
public class Notification_receiver5 extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
       ...
       // }
        ...
        PendingIntent pendingIntent5 = PendingIntent.getActivity(context, 105, repeating_intent, PendingIntent.FLAG_UPDATE_CURRENT);

        // Interest 5

        NotificationCompat.Builder builder5 = new NotificationCompat.Builder(context, CHANNEL_ID)
        ...
        if (name[4] != "")
            notificationManager.notify((105), builder5.build());
